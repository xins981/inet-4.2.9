//
// Generated file, do not edit! Created by nedtool 5.7 from inet/physicallayer/contract/packetlevel/SignalTag.msg.
//
...
bool SignalTimeIndDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    SignalTimeInd *pp = (SignalTimeInd *)object; (void)pp;
    switch (field) {
        case FIELD_startTime: pp->setStartTime(string2simtime(value)); return true;
        case FIELD_endTime: pp->setEndTime(string2simtime(value)); return true;
        default: return false;
    }
}
