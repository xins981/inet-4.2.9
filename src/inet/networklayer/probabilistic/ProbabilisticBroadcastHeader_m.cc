//
// Generated file, do not edit! Created by nedtool 5.7 from inet/networklayer/probabilistic/ProbabilisticBroadcastHeader.msg.
//
...
bool ProbabilisticBroadcastHeaderDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_appTtl: pp->setAppTtl(string2simtime(value)); return true;
