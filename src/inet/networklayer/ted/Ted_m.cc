//
// Generated file, do not edit! Created by nedtool 5.7 from inet/networklayer/ted/Ted.msg.
//
...
bool TeLinkStateInfoDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_timestamp: pp->timestamp = string2simtime(value); return true;
