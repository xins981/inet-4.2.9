...
class INET_API Ipv4OptionsTagBase : public ::inet::TagBase
{
  ...
  public:
    void appendOption(Ipv4Option *option) { insertOption(option); }
    Ipv4Option *removeOption(size_t k) { return dropOption(k); }
#endif
};
...
/**
 * Class generated from <tt>inet/networklayer/ipv4/Ipv4OptionsTag.msg:28</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>inet/networklayer/ipv4/Ipv4OptionsTag.msg:35</tt> by nedtool.
 * <pre>
 * //
