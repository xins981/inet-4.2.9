//
// Generated file, do not edit! Created by nedtool 5.7 from inet/networklayer/ipv4/Ipv4Route.msg.
//
...
void *Ipv4RouteDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_netmask: return toVoidPtr(&pp->getNetmask()); break;
        case FIELD_gateway: return toVoidPtr(&pp->getGateway()); break;
        default: return nullptr;
    }
}
