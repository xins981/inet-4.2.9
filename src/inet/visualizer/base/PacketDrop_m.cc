//
// Generated file, do not edit! Created by nedtool 5.7 from inet/visualizer/base/PacketDrop.msg.
//
...
const char *PacketDropDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::InterfaceEntry",    // FIELD_networkInterface
...
const char *PacketDropDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_networkInterface: { const InterfaceEntry * value = pp->getNetworkInterface(); return omnetpp::opp_typename(typeid(*value)); }
        default: return nullptr;
    }
}
...
const char *PacketDropDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        ...
        case FIELD_networkInterface: return omnetpp::opp_typename(typeid(InterfaceEntry));
