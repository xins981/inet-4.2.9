//
// Generated file, do not edit! Created by nedtool 5.7 from inet/applications/voip/SimpleVoipPacket.msg.
//
...
bool SimpleVoipPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_voipTimestamp: pp->setVoipTimestamp(string2simtime(value)); return true;
        case FIELD_voiceDuration: pp->setVoiceDuration(string2simtime(value)); return true;
