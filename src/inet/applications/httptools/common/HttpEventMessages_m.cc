//
// Generated file, do not edit! Created by nedtool 5.7 from inet/applications/httptools/common/HttpEventMessages.msg.
//
...
bool HttpServerStatusUpdateMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_setTime: pp->setSetTime(string2simtime(value)); return true;
