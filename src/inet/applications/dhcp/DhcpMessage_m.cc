//
// Generated file, do not edit! Created by nedtool 5.7 from inet/applications/dhcp/DhcpMessage.msg.
//
...
bool DhcpOptionsDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_renewalTime: pp->setRenewalTime(string2simtime(value)); return true;
        case FIELD_rebindingTime: pp->setRebindingTime(string2simtime(value)); return true;
        case FIELD_leaseTime: pp->setLeaseTime(string2simtime(value)); return true;
