//
// Generated file, do not edit! Created by nedtool 5.7 from inet/applications/packetdrill/PacketDrillInfo.msg.
//
...
unsigned int PacketDrillInfoDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_scriptTime
        FD_ISEDITABLE,    // FIELD_scriptTimeEnd
        FD_ISEDITABLE,    // FIELD_offset
        FD_ISEDITABLE,    // FIELD_timeType
        FD_ISEDITABLE,    // FIELD_liveTime
    };
...
bool PacketDrillInfoDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    PacketDrillInfo *pp = (PacketDrillInfo *)object; (void)pp;
    switch (field) {
        case FIELD_scriptTime: pp->setScriptTime(string2simtime(value)); return true;
        case FIELD_scriptTimeEnd: pp->setScriptTimeEnd(string2simtime(value)); return true;
        case FIELD_offset: pp->setOffset(string2simtime(value)); return true;
        case FIELD_timeType: pp->setTimeType(string2ulong(value)); return true;
        case FIELD_liveTime: pp->setLiveTime(string2simtime(value)); return true;
